            ...
            <div class="modal-body d-none" id="modal-body-edit-provider">
                <form action="" method="POST" id="formeditprovider">
                    ...
                    <div class="mb-2">
                        ...
                        <input type="text" class="form-control form-control-sm validate" name="first_name" required value="{{ old('first_name') }}">
                    </div>
                    <div class="mb-2">
                        <label for="last_names" class="form-label mb-0 ps-3 fw-bold">Apellido</label>
                        <input type="text" class="form-control form-control-sm validate" name="last_names" required value="{{ old('last_names') }}">
                    </div>
                    <div class="row">
                        ...
                        <div class="col-12 col-lg-6">
                            <div class="mb-2">
                                ...
                                <input type="text" class="form-control form-control-sm validate" name="num_doc" required value="{{ old('num_doc') }}">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-12 col-lg-6">
                            <div class="mb-2">
                                ...
                                <input type="text" class="form-control form-control-sm validate" name="phone1" value="{{ old('phone1') }}">
                            </div>
                        </div>
                        <div class="col-12 col-lg-6">
                            <div class="mb-2">
                                <label for="phone2" class="form-label mb-0 ps-3 fw-bold">Teléfono 2</label>
                                <input type="text" class="form-control form-control-sm" name="phone2" value="{{ old('phone2') }}">
                            </div>
                        </div>
                        <div class="col-12 col-lg-6">
                            <div class="mb-2">
                        ...
                        <div class="col-12 col-lg-6">
                            <div class="mb-2">
                                ...
                                <input type="text" class="form-control form-control-sm" name="state" value="{{ old('state') }}">
                            </div>
                        </div>
                        <div class="col-12 col-lg-6">
                            <div class="mb-2">
                        ...
                        <div class="col-12 col-lg-6">
                            <div class="mb-2">
                                ...
                                <input type="text" class="form-control form-control-sm" name="address_street" value="{{ old('address_street') }}">
                            </div>
                        </div>
                        <div class="col-12 col-lg-6">
                            <div class="mb-2">
                                <label for="address_nro" class="form-label mb-0 ps-3 fw-bold">Nro</label>
                                <input type="text" class="form-control form-control-sm" name="address_nro" value="{{ old('address_nro') }}">
                            </div>
                        </div>
                        <div class="col-12 col-lg-6">
                            <div class="mb-2">
                                <label for="address_apartament" class="form-label mb-0 ps-3 fw-bold">Piso / Dpto</label>
                                <input type="text" class="form-control form-control-sm" name="address_apartament" value="{{ old('address_apartament') }}">
                            </div>
                        </div>
                    </div>
                    <div class="mb-2">
                        <label for="address_detail" class="form-label mb-0 ps-3 fw-bold">Descripcion</label>
                        <input type="text" class="form-control form-control-sm" name="address_detail" value="{{ old('address_detail') }}">
                    </div>
                </form>
            </div>
            <div class="modal-footer d-none" id="modal-footer-edit-provider">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
                <button type="button" class="btn btn-type1" id="btn-update-provider">Actualizar</button>
            </div>
        </div>
    </div>
</div>
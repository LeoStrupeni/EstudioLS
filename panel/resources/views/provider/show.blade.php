<div class="modal fade" id="showprovider" tabindex="-1" aria-hidden="true" >
    <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <div class="modal-body d-none" id="modal-body-show-provider-error">
            ...
            <div class="modal-body" id="modal-body-show-provider-roller">
                <div style="display:block;" class="text-center">
                    <br>
                    <br>
            ...
            <div class="modal-body d-none" id="modal-body-show-provider">

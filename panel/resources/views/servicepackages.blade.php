...
@section('Content')
        ...
        <div class="row justify-content-center my-4">
            <div class="col-12 col-lg-10 bg-white rounded p-2">
                <div class="row align-items-center  justify-content-between">
                    <div class="col">
                        <div class="navbar-brand ps-3 fs-5">Listado de Paquetes</div>
                    </div>
                    <div class="col">
                        <button type="button" class="btn btn-danger float-end mx-1" onclick="callregister('/service_package/table',1,$('#table_limit').val(),$('#table_order').val(),'si')"><i class="fa-solid fa-arrows-rotate"></i></button>
                    ...
                    <table class="table table-sm table-hover text-center sortable" id="table">
                        <thead>
                            <tr>
                                ...
                                <th class="column_orden" data-name="type_money"># servicios</th>
    ...
    {{-- @include('home.foot') --}}
    @include('servicepackages.create')
    @include('servicepackages.edit')
    @include('destroyforms')
    @include('servicepackages.show')
@endsection

@section('script_by_page')
    <script src="{{env('APP_URL')}}/assets/js/local/servicepackages.js"></script>
@endsection

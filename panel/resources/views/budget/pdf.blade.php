...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <!-- Utility classes for typography and spacing Bot5.3 -->
    <style>
        .fs-1 {
    ...
    <style>
        ...
        */
        ...
        @media print {
            ...
            .a4-page {
                width: 210mm;
                height: 297mm;
                margin: 0; /* Elimina el margen del navegador para impresión */
                box-shadow: none; /* Elimina la sombra para impresión */
                padding: 0; /* Ajusta el padding para impresión si es necesario */
            }
        }
        ...
        *{color: #836870!important; font-family: Arial; line-height: 1.3;}
        ...
        li {
            margin-bottom: .5em; /* Añade espacio debajo de cada elemento */
        }

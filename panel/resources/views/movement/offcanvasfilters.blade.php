<div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasFiltersMovs" aria-labelledby="offcanvasFiltersMovsLabel">
    ...
    <div class="offcanvas-body">
        ...
        <div class="mb-3">
            ...
            <select class="form-select" id="type" data-placeholder="Todos" multiple>
        ...
        <div class="mb-3">
            ...
            <select class="form-select" id="type_money" data-placeholder="Todas" multiple>
        ...
        <div class="mb-3">
            ...
            <select class="form-select" id="type_document" data-placeholder="Todos" multiple>
        ...
        <div class="mb-3">
            ...
            <select class="form-select" id="type_payment" data-placeholder="Todos" multiple>

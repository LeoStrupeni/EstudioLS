<div class="modal fade" id="showmovement" tabindex="-1" aria-hidden="true" >
    <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Ver Movimiento</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body d-none" id="modal-body-show-movement-error">
            ...
            <div class="modal-body" id="modal-body-show-movement-roller">
                <div style="display:block;" class="text-center">
                    <br>
                    <br>
            ...
            <div class="modal-body d-none" id="modal-body-show-movement">
                <form id="formshowmovement">
                    <div class="mb-2">

        ...
        <div class="row justify-content-center my-4">
            <div class="col-12 col-lg-10 bg-white rounded p-2">
                <div class="row align-items-center  justify-content-between">
                    <div class="col">
                        <div class="navbar-brand ps-3 fs-5">Listado de Presupuestos</div>
                    </div>
                    <div class="col">
                        <button type="button" class="btn btn-danger float-end mx-1" onclick="callregister('/budget/table',1,$('#table_limit').val(),$('#table_order').val(),'si')"><i class="fa-solid fa-arrows-rotate"></i></button>

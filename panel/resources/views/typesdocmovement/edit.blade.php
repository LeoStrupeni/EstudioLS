    ...
    <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <div class="modal-body d-none" id="modal-body-edit-typesdocmov">
                <form action="" method="POST" id="formedittypesdocmov">
                    ...
                    <div class="mb-2">
                        ...
                        <select class="form-select form-select-sm validate" name="type" id="e_type" style="width: 100%" required>
            ...
            <div class="modal-footer d-none" id="modal-footer-edit-typesdocmov">
                ...
                <button type="button" class="btn btn-type1" id="btn-update-typesdocmov">Actualizar</button>
            </div>
        </div>
    </div>
</div>